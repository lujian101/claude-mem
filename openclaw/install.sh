...
CLAUDE_MEM_REPO="https://github.com/lujian101/claude-mem.git"
...
find_claude_mem_install_dir() {
  ...
  local -a search_paths=(
    ...
    "${HOME}/.claude/plugins/marketplaces/lujian101"
...
start_worker() {
  ...
  if ! find_claude_mem_install_dir; then
    ...
    error "  ~/.claude/plugins/marketplaces/lujian101/plugin/scripts/"
    error ""
