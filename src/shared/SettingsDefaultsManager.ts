...
export interface SettingsDefaults {
  ...
  CLAUDE_MEM_WORKER_AUTO_START: string;       // 'true' | 'false' - auto-spawn worker when needed (default: true)
  CLAUDE_MEM_HOOK_TOTAL_TIMEOUT_MS: string;   // Process-level safety net for hooks (default: 30000)
  // Exclusion Settings
...
export class SettingsDefaultsManager {
  ...
  private static readonly DEFAULTS: SettingsDefaults = {
    ...
    CLAUDE_MEM_OPENROUTER_BASE_URL: 'https://openrouter.ai/api/v1/chat/completions',  // Default OpenRouter endpoint
    ...
    CLAUDE_MEM_WORKER_AUTO_START: 'true',    // Auto-spawn worker daemon when needed
    CLAUDE_MEM_HOOK_TOTAL_TIMEOUT_MS: '30000',  // Hook process-level safety net (ms)
    // Exclusion Settings
